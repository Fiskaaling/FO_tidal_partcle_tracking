    ...
    class interactive_plot:
        ...
        def play(self, event):
            ...
            if self.initial!=1:
                ...
                num_particles_old = self.df3.id.unique()-self.df3.id.unique()
                ...
                while True:
                    ...
                    for idx in num_particles:
                        ...
                        if idx not in have_particles_enterd:
                            ...
                            if len(df_now_per_id.x)!=0:
                                markers.extend(ax.plot(df_now_per_id.x.iloc[-1], df_now_per_id.y.iloc[-1], 'o', c = cmap(random_color), markersize=4))
                    ...
                    print(lines, markers,np.size(self.df3))
                    ...
                    end4 = time.time()
                    print(f'time to plot rest: {end4 - start2}')
...
#
 ...
 #           self.start_date = dates.date2num(pd.to_datetime(expression))
    ...
    #bfull.on_clicked(full
    cid = fig.canvas.mpl_connect('button_press_event', Interactive_plot.onclick) # 'key_press_event'
#===============================================================
    ...
    fig.set_size_inches(14.69, 10.27)
